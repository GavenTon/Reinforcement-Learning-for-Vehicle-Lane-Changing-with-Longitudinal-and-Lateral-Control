...
class CarEnv:
    ...
    def __init__(self):
        ...
        #self.world.set_weather(getattr(carla.WeatherParameters, 'Cloudy'))
        self.blueprint_library = self.world.get_blueprint_library()
        self.model_3 = self.blueprint_library.filter("model3")[0]
        self.model_3.set_attribute('color', "250,235,215")

        self.model_4 = self.blueprint_library.filter("model3")[0]
        self.model_4.set_attribute('color', "138,43,226")

        self.model_5 = self.blueprint_library.filter("model3")[0]
        self.model_5.set_attribute('color', "64,232,128")
    ...
    def reset(self):
        ...
        if rand_num == 0:
            ...
            from PIDControllerrr import VehiclePIDController
    ...
    def option1_action(self, action):
        ...
        if action == 0:
            ...
            self.world.debug.draw_point(ego_waypoint.transform.location, size = 0.0003, life_time = 2.0)
            #self.world.debug.draw_string(ego_waypoint.transform.location, str('%15.0f km/h' % (3.6 * math.sqrt((self.vehicle.get_velocity()).x**2 + (self.vehicle.get_velocity()).y**2 + (self.vehicle.get_velocity()).z**2))), life_time = 2.0)
            self.world.debug.draw_point(to_draw_waypoint_final.transform.location, size = 0.0003, life_time = 2.0)
            self.world.debug.draw_line(ego_waypoint.transform.location, to_draw_waypoint_final.transform.location, thickness = 0.0003, life_time = 2.0)
            atime = 0.65
            start_time = time.time()
            while time.time() < start_time + atime:
                control = self.controller.run_step(target_speed, waypoint_final)
        ...
        # Slow Moving Foward
           ...
           # self.world.debug.draw_string(ego_waypoint.transform.location, str('%15.0f km/h' % (3.6 * math.sqrt((self.vehicle_ego.get_velocity()).x**2 + (self.vehicle_ego.get_velocity()).y**2 + (self.vehicle_ego.get_velocity()).z**2))), life_time = 2.0)
            self.world.debug.draw_point(waypoint_final.transform.location, size = 0.0003, life_time = 2.0)
            ...
            self.world.debug.draw_line(ego_waypoint.transform.location, waypoint_final.transform.location, thickness = 0.0003, life_time = 2.0)
            target_speed = 14
            # 0.2,
            a2time = 0.60
        ...
        # Fast Moving Forward
            ...
            self.world.debug.draw_point(ego_waypoint.transform.location, size = 0.0003, life_time = 2.5)
            ...
            self.world.debug.draw_point(waypoint_final.transform.location, size = 0.0003, life_time = 2.5)
            #self.world.debug.draw_string(waypoint_final.transform.location, str('%15.0f km/h' % (3.6 * math.sqrt((self.vehicle.get_velocity()).x**2 + (self.vehicle.get_velocity()).y**2 + (self.vehicle.get_velocity()).z**2))), life_time = 2.0)
            self.world.debug.draw_line(ego_waypoint.transform.location, waypoint_final.transform.location, thickness = 0.0003, life_time = 2.5)
            target_speed = 17
            # 0.40
            a3time = 0.78
    ...
    def option2_action(self, action):
        ...
        if lane_change == 'Right':
            ...
            self.world.debug.draw_point(ego_waypoint.transform.location, size = 0.0003, color = carla.Color(255, 255, 255), life_time = 2.0)
            self.world.debug.draw_point(final_waypoint.transform.location, size = 0.0001, color = carla.Color(255, 255, 255), life_time = 2.0)
            self.world.debug.draw_line(ego_waypoint.transform.location, final_waypoint.transform.location, thickness = 0.0004, color = carla.Color(255, 255, 255), life_time = 2.0)
            lchange_time = 0.50
            start_time = time.time()
            ...
            self.world.debug.draw_line(ego_waypoint.transform.location, final_location, thickness = 0.0003, color = carla.Color(255, 255, 255), life_time = 2.5)
            ...
            self.world.debug.draw_point(waypoint_final2.transform.location, size = 0.0003, color = carla.Color(255,255, 255), life_time = 2.0)
            self.world.debug.draw_line(final_waypoint.transform.location, waypoint_final2.transform.location, thickness = 0.0004, color = carla.Color(255, 255, 255), life_time = 2.0)
            correct_time = 0.75
            ...
            self.world.debug.draw_line(final_location, waypoint_final2.transform.location, thickness = 0.0003, color = carla.Color(255, 255, 255), life_time =2.0)
